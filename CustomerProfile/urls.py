...
from .views import ListCustomerNames , GetOneCustomer , UpdateCustomerImage , GetDataCustomerHome ,  ListBasicCustomerData
...
urlpatterns = [
    ...
    path('getbasiccustomerdata/' , ListBasicCustomerData.as_view() , name='user')
]
